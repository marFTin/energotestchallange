...
namespace Communication {
    namespace Server {
        ...
        public:
            ...
            /*!
             *
             * @return std::nullopt in case of error, otherwise Payload which can have zero size
             */
            ...
            /*!
             *
             * @param _payload data to send
             * @return std::nullopt in case of error or number of transferred bytes
             */
